                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item md={8}>
                        ...
                        <p className="about__description">
                         I'm a Web Developer passionate about frontend and backend technologies. I enjoy building everything and always dedicate time to expanding my knowledge in order to improve my skills and offer a better service. <br/><br/>
